...
// protected MyRunnable myRnabl;
 ...
 public Update(Context c,String u)
 {
  ...
  boolHasNew=true;
//  myRnabl=new MyRunnable(strUrl,handler,MyRunnable.HTTP_MODEL_GET_RESOURCE_CODE);
 }
 ...
 private boolean getAllUpdate(Object obj)
 {
  ...
  s=s.substring(
   s.indexOf(strPackageName+"U{")+strPackageName.length()+1,
   s.indexOf("}U"+strPackageName)+1);
  try
  {
